...
using MenuController = GClass1143;
...
namespace SPTarkov.SinglePlayer.Patches.ScavMode
{
    ...
    public class LoadOfflineRaidScreenPatch : GenericPatch<LoadOfflineRaidScreenPatch>
    {
        ...
        private static readonly string kMainControllerFieldName = "GClass1143_0";
        ...
        public static void LoadOfflineRaidScreenForScav()
        {
            ...
            MatchmakerOfflineRaid.GClass1908 gclass = new MatchmakerOfflineRaid.GClass1908();
